...
function Start-GameService {
    ...
    Send-Notification admin "serverStarting" @{ reason = $Context }
    ...
    try {
        ...
        if ($service.Status -eq 'Running') {
            ...
            Send-Notification admin "serverOnline" @{ reason = "already running" }
...
function Stop-GameService {
    ...
    try {
        ...
        if ($service.Status -eq 'Stopped') {
            ...
            Send-Notification admin "serverOffline" @{ reason = "already stopped" }
        ...
        Send-Notification admin "serverStopped" @{ context = $Reason }
        Send-Notification player "serverOffline" @{}
        return $true
    }
    catch {
...
function Restart-GameService {
    ...
    Send-Notification player "serverRestarting" @{}
